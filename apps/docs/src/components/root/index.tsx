        ...
        <Sidebar defaultOpenLevel={defaultOpenLevel} prefetch={prefetch}>
          ...
          <LayouttRoot className="main-container px-1 md:px-3">
            ...
            <LayoutBody
              ...
              className="bg-(--surface-background) border border-(--neutral-border-medium) dark:border-(--neutral-border-weak) radius-xs-4 min-h-[calc(100vh_-_60px)] max-h-[calc(100vh_-_60px)] overflow-y-auto"
            >
              {/* {nav.enabled !== false &&
              (nav.component ?? (
                <LayoutHeader
