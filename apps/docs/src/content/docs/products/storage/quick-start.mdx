...
<Check>
That's it! You now have working file storage. Check out our [storage security guide](/products/storage/security) to learn about permissions and access control.
</Check>