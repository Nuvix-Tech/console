---
title: Textmagic
description: Send SMS messages to your Nuvix users using Textmagic and Nuvix Messaging.
---
...
In the **Configure** step, you will need to provide details from your Textmagic dashboard to connect your Nuvix project.
...
const provider = await nx.messaging.updateTextmagicProvider(
  '<PROVIDER_ID>',
  '<NAME>',                    // name (optional)
