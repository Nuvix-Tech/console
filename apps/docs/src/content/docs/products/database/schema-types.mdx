...
<Check>
Managed schemas provide the best of both worlds: PostgreSQL power with Nuvix automation.
</Check>

## Unmanaged Schema

A raw PostgreSQL schema exposed through the Nuvix API without automation. You get complete control over schema design, SQL queries, and access policies.
