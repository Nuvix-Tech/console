            ...
            <div className="w-full flex flex-col gap-3">
                {tables.map((table, idx) => (
                    <div key={table.name} className="flex items-center justify-between w-full">
                        {/* Table name (left) */}
                        <Tag textVariant="body-default-xs" prefixIcon="table" variant="info" className="backdrop-blur !text-(--neutral-on-background-weak)">
                            {table.name}
                        </Tag>
                        ...
                        <Tag textVariant="body-default-xs" variant="neutral" className="backdrop-blur">
                            <span className="!text-(--neutral-on-background-weak)">.../v1/</span>{table.endpoint}
                        </Tag>
                    </div>
                ))}
            </div>
