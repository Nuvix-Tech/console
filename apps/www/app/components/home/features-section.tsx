...
export function FeaturesSection() {
  return (
    <div className="pb-24 cont px-3">
      <ul
        data-theme="dark"
        className="grid grid-cols-1 gap-4 md:grid-cols-10 md:grid-rows-3 !p-2 md:!p-4 lg:!p-8 page-background radius-xs"
      >
        ...
        <GridItem
          ...
          extra={
            <Mask
              ...
              y={-200}
              radius={238}
              className="!hidden lg:!block neutral-on-background-weak"
            >
              <svg
                fill="none"
                viewBox="0 0 96 96"
