    ...
    <div className="container mx-auto px-4 py-8">
      ...
      >
        <Column 
          ...
          style={{
            background: "linear-gradient(135deg, var(--brand-alpha-weak) 0%, var(--neutral-alpha-weak) 50%, var(--accent-alpha-weak) 100%)",
          }}
        >
          {/* Subtle grid pattern */}
          <div 
          ...
          <div className="mx-auto max-w-2xl text-center my-auto relative z-10">
            ...
            >
              <Text onBackground="neutral-weak" as="p" className="mt-4 text-lg leading-relaxed">
                Nuvix is open-source and free to self-host. 
