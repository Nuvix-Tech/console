    ...
    return (
        <div className="flex flex-col gap-2 overflow-hidden">
            <AnimatePresence mode="popLayout">
                ...
                <Column background="info-weak" radius="s" gap="4" className="p-4 w-3/4 ml-auto -mt-4 z-10" border="neutral-medium">
                    <Row vertical="center" gap="12" horizontal="space-between" fillWidth borderBottom="neutral-weak" className="pb-2 px-1">
                    ...
                    {sessions.map((s) => (
                        ...
                        >
                            <div className="flex items-center gap-3 justify-start w-full flex-1">
                                <Text variant="body-default-xs" onBackground="neutral-strong">{s.device}</Text>
                                <Text variant="body-default-xs" onBackground="neutral-medium" className="ml-auto">{s.location}</Text>
                            </div>
                        </motion.div>
                    ))}
                </Column>
...
const SessionLimit = () => {
    return (
        <>
            ...
            <Column background="surface" radius="s" gap="4" className="p-4 h-16 mt-4 -mb-10" />
        </>
    )
}
...
const MFAVisualCard = () => {
    return (
        <Row gap="4" fill vertical="center" horizontal="center">
            {
                [3, 5, 4, 9, "", ""].map((a, i) => <div key={i} className="size-8 rounded-full flex items-center justify-center neutral-background-alpha-medium">
                    <Text variant="body-default-xs" onBackground="neutral-strong">{a}</Text>
                </div>)
            }
        </Row>
    );
