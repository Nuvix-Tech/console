            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="mb-20">
                    ...
                    <Text variant="body-default-l" onBackground="neutral-medium" className="max-w-2xl">
                        No image processing server needed. Just add parameters to the URL. Resize, crop,
                        convert formats - all cached automatically.
                    </Text>
                </div>
                ...
                <div className="space-y-12">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                        <div>
                            ...
                            <Text variant="heading-strong-l" as="h3" onBackground="neutral-strong" className="mb-4">
                                ?width=800
                            </Text>
                        ...
                        <div data-theme="dark" className="rounded-sm page-background p-8 border-2 border-neutral-weak">
...
getFilePreviewURL({
  ...
  borderColor: '3B82F6'
                ...
                {/* Bottom Note */}
                <div data-theme="dark" className="mt-20 p-8 page-background rounded-lg border-2 neutral-border-weak">
                    <Column gap="s">
