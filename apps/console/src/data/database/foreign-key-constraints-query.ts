...
export async function getForeignKeyConstraints(
  { projectRef, sdk, schema }: ForeignKeyConstraintsVariables,
  signal?: AbortSignal,
) {
...
export const useForeignKeyConstraintsQuery = <TData = ForeignKeyConstraintsData>(
  { projectRef, sdk, schema }: ForeignKeyConstraintsVariables,
  {
    enabled = true,
    ...options
  }: QueryOptions<ForeignKeyConstraintsData, ForeignKeyConstraintsError, TData> = {},
) =>
  useQuery({
    queryKey: databaseKeys.foreignKeyConstraints(projectRef, schema),
    queryFn: ({ signal }) => getForeignKeyConstraints({ projectRef, sdk, schema }, signal),
