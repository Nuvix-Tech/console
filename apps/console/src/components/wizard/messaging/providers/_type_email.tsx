    ...
    const renderProviderFields = () => {
        switch (providerType) {
            case "mailgun":
                return (
                    <>
                        <InputField name="apiKey" label="API Key" placeholder="Enter API key" type="password" required />
            ...
            case "smtp":
                return (
                    <>
                        ...
                        <InputField name="smtpPassword" label="Password" type="password" placeholder="Enter password" />
                        <InputSelectField
                            name="smtpEncryption"
                            label="Encryption"
                            options={[
