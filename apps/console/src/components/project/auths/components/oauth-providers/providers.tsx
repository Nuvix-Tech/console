...
import { Apple } from "./_apple_oauth";
import { Auth0 } from "./_auth0_oauth";
...
import { Google } from "./_google_oauth";
import { Main } from "./_main_oauth";
import { Microsoft } from "./_microsoft_oauth";
import { Oidc } from "./_oidc_oauth";
import { Okta } from "./_okta_oauth";

export type Provider = {
  name: string;
  icon: string;
  docs?: string;
  component: ({ provider }: { provider: Models.AuthProvider }) => React.JSX.Element;
};
