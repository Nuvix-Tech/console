...
export const LockedCreateQuerySection = ({
  ...
  return (
    <div className="neutral-background-alpha-medium pt-2 pb-1">
      <div className="flex items-center justify-between px-5 mb-1">
        <div className="flex items-center">
          <div className="pl-0.5 pr-5 flex items-center justify-center">
            <Lock size={14} className="neutral-on-background-weak" />
          </div>
          <p className="text-xs neutral-on-background-weak font-mono uppercase">
            Use options above to edit
          </p>
        </div>
      </div>
      <div className="flex items-start" style={{ fontSize: "14px" }}>
        <p className="px-6 font-mono text-sm neutral-on-background-medium select-none">1</p>
      ...
      <div className="flex items-start" style={{ fontSize: "14px" }}>
        <p className="px-6 font-mono text-sm neutral-on-background-medium select-none">2</p>
        <p className="font-mono tracking-tighter">
      ...
      {!isEditing && (
        <>
          <div className="flex items-start" style={{ fontSize: "14px" }}>
            <p className="px-6 font-mono text-sm neutral-on-background-medium select-none">3</p>
            <p className="font-mono tracking-tighter">
              <span className="text-[#569cd6]">as</span> {behavior.toLocaleUpperCase()}
            </p>
          </div>
          <div className="flex items-start" style={{ fontSize: "14px" }}>
            <p className="px-6 font-mono text-sm neutral-on-background-medium select-none">4</p>
            <p className="font-mono tracking-tighter">
      ...
      <div className="flex items-start" style={{ fontSize: "14px" }}>
        <p className="px-6 font-mono text-sm neutral-on-background-medium select-none">5</p>
        <p className="font-mono tracking-tighter">
          <span className="text-[#569cd6]">to</span> {roles.length === 0 ? "public" : roles}
        </p>
      </div>
      <div className="flex items-start" style={{ fontSize: "14px" }}>
        <p className="px-6 font-mono text-sm neutral-on-background-medium select-none">6</p>
        <p className="font-mono tracking-tighter">
