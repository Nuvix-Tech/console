  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 md:gap-12">
      <div className="flex md:w-1/3 flex-col space-y-2">
        <label className="text-base neutral-on-background-medium" htmlFor="policy-name">
          Policy name
        </label>
        <p className="text-sm neutral-on-background-weak">A descriptive name for your policy</p>
      </div>
      <div className="relative md:w-2/3">
        <Input
          ...
          // actions={
          //   <span className="mr-3 text-sm neutral-on-background-weak">
          //     {name.length}/{limit}
          //   </span>
          // }
        />
