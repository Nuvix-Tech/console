...
const Indexes = () => {
    ...
    if (isErrorIndexes) return <AlertError error={indexesError} subject="Failed to retrieve database indexes" />;
        ...
        <>
            <div className="w-full space-y-4">
                ...
                >
                    ...
                    {indexes.length > 0 || (search.length > 0 && <Table noResults={indexes.length === 0 && search.length > 0} />)}
                </DataGridProvider>
            </div>
