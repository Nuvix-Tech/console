...
import { EnumeratedType, useEnumeratedTypesQuery } from "@/data/enumerated-types/enumerated-types-query";
...
const EnumeratedTypes = ({
    ...
    if (isError) return <AlertError error={error} subject="Failed to retrieve database enumerated types" />;
        ...
        <div className="w-full space-y-4">
            ...
            >
                ...
                {(filteredEnumeratedTypes.length > 0 ||
                    hasQuery) && <Table noResults={filteredEnumeratedTypes.length === 0 && hasQuery} />}
            </DataGridProvider>
