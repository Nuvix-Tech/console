    ...
    return (
        <>
            <ConfirmationModal
                ...
                title={`Confirm deletion of column "${snap.confirmationDialog?.type === 'column' && snap.confirmationDialog.column.name
                    }"`}
                confirmLabel="Delete"
                ...
                <div className="space-y-4">
                    ...
                    {isDeleteWithCascade && (
                        ...
                        >
                            ...
                            <AlertDescription>
                                <Button asChild size="s" variant="secondary" prefixIcon={<ExternalLink size={14} />}>
                                    <Link
