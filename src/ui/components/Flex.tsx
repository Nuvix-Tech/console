...
const Flex = forwardRef<HTMLDivElement, ComponentProps>(
  (
    ...
    const classes = classNames(
      ...
      padding && `rp-${padding}`,
      paddingLeft && `rpl-${paddingLeft}`,
      paddingRight && `rpr-${paddingRight}`,
      paddingTop && `rpt-${paddingTop}`,
      paddingBottom && `rpb-${paddingBottom}`,
      paddingX && `rpx-${paddingX}`,
      paddingY && `rpy-${paddingY}`,
      margin && `rm-${margin}`,
      marginLeft && `rml-${marginLeft}`,
      marginRight && `rmr-${marginRight}`,
      marginTop && `rmt-${marginTop}`,
      marginBottom && `rmb-${marginBottom}`,
      marginX && `rmx-${marginX}`,
      marginY && `rmy-${marginY}`,
      gap === "-1"
